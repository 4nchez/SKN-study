...
`nlp-model`는 자연어 처리 실습용 PyCharm 프로젝트입니다.  
...
git branch -M main
git remote add origin https://github.com/사용자계정/nlp-model.git
git push -u origin main
```

GitHub에서 `nlp-model` 이름으로 빈 리포지토리를 먼저 만든 뒤, 위 명령의 주소를 본인 저장소 주소로 바꾸면 됩니다.
