"""12_print_metadata_genai.py 역할: 문제 3 — metadata 출처 추적"""  # 이 파일은 서비스 검색 단계입니다.
...
from common import EXERCISE_FAISS_DIR, get_embeddings, print_documents  # 공통 경로, 임베딩, 출력 함수를 불러옵니다.
...
def main() -> None:  # PyCharm 실행 진입점입니다.
    question = "VIP 적립률"  # 실습용 검색 질문입니다.
    results = search(question, k=1)  # 저장된 인덱스에서 질문과 가까운 청크 3개를 찾습니다.
