...
MENU: Dict[str, tuple[str, str]] = {  # 사용자가 선택할 메뉴 번호와 모듈 정보를 저장합니다.
    ...
    # 10번 부터 14번은 실습문제입니다.
    "10": ("10. 실습문제1", "10_build_index_genai"),
    "11": ("11. 실습문제2", "11_service_genai"),
    "12": ("12. 실습문제3 - 메타데이터 출력", "12_print_metadata_genai"),
    "13": ("13. 실습문제4 - 인덱스 증분 업데이트", "13_incremental_update_genai"),
    "14": ("14. 실습문제5 - 메타데이터 필터링 검색", "14_filter_search_genai"),
}  # 메뉴 딕셔너리 정의를 끝냅니다.
