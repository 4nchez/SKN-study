...
- 학습된 모델로 새 문장 번역
- 반복 학습 수, 최적화 함수, 손실 함수, Transformer 차원 등을 조절하는 최적화
...
## 참고
이 예제는  문자 단위 Transformer 기반 모델입니다. 
실제 상용 번역기 수준의 품질을 원한다면 더 많은 병렬 말뭉치, SentencePiece 토크나이저, BLEU/chrF 평가 등을 추가해야 합니다.
