# path : my_collections/test_tuple/tuple_sample.py
...
def tuple_caution():
    ...
    # 튜플 사용시 주의사항
    # 튜플 생성시 1개의 값만 가질 때는, 반드시 값 뒤에 쉼표(,) 붙일 것
    tpl_1 = (1)
    ...
    # 참고 사항 : 하나의 변수에 소괄호 () 없이 여러개의 값을 나열해서 대입하면 자동 튜플이 됨
    x = 1, 2, 3
...
def tuple_builtin():
    ...
    print(f'tpl에 저장된 11의 갯수 : {number_count}') # 1
    ...
    print(f'tpl에 저장된 데이터 갯수 : {len(tpl)}')
    return