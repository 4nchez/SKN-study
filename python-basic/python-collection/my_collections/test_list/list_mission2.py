# file path : my_collections/test_list/list_mission2.py
...
def practice():
    ...
    sungjuk_list = [d1, d2, d3]
    total = d1[-2] + d2[-2] + d3[-2]
    avg_total = total / 3
    for i in sungjuk_list:
        print('국어 : {}, 영어 : {}, 수학 : {}, 총점 : {}, 평균 : {:.2f}'.format(int(i[0]),int(i[1]),int(i[2]),int(i[3]),i[4]))
    print('총합 : {}, 전체평균 : {:.2f}'.format(int(total), avg_total))
    return
...
def input_data():
    ...
    return [kor, eng, mat, total, total / 3]
